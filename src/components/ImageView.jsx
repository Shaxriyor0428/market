  ...
  return (
    <div className="container mx-auto p-8">
      <Swiper
        ...
        className="mySwiper select-none w-[900px] max-lg:w-[700px] max-custom-md:w-[600px] max-sm:w-[450px] max-custom-sm:w-[350px] bg-gradient-to-r from-white via-gray-100 to-white dark:from-slate-800 dark:via-slate-700 dark:to-slate-800 rounded-lg shadow-lg overflow-hidden"
      >
